...
def parameter_parser():
    ...
    parser.add_argument("--data-type", type=str, default="resistance_ctrl", choices=['itv_eval', 'activation_spread_eval', 'resistance_ctrl', 'robust'])
...
if __name__ == "__main__":
    ...
    class QNA_Config:
        ...
        num_steps = [-2,-1,0,1]
        itv_type_dict = dict(zip(num_steps, (['phase_3'] * len(num_steps))))

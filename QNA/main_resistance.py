...
def parameter_parser():
    ...
    parser.add_argument("--data-type", type=str, default="robust", choices=['itv_eval', 'activation_spread_eval', 'resistance_ctrl', 'robust'])
    parser.add_argument("--itv-t", type=int, default=0)
    parser.add_argument("--num-samples", type=int, default=45)
